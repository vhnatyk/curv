...
impl Hash for HSha512 {
    fn create_hash(big_ints: &[&BigInt]) -> BigInt {
        ...
        let mut result = [0; 64]; //TODO: parametrize 32/64 usize to fit both SHA256/512 algorithms
    ...
    fn create_hash_from_ge(ge_vec: &[&GE]) -> FE {
        ...
        hasher.input(&flatten_array);
        let mut result_buf = [0; 64]; //TODO: parametrize 32/64 usize to fit both SHA256/512 algorithms
